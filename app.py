...
"""
                    ...
                    if llm_provider == "Gemini AI":
                        ...
                        if groq_api_key:
                            chat_groq = ChatGroq(groq_api_key=groq_api_key, model_name="meta-llama/llama-guard-4-12b")
                            try:
                                ...
                                answer_raw = f"Groq API error: {e}. This could be due to the chosen Groq model ('meta-llama/llama-guard-4-12b') not being available or an API issue, or the input context being too long for the model."
                        else:
